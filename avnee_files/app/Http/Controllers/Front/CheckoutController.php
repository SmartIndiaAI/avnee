...
class CheckoutController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('front.checkout.index', compact('cart', 'theme', 'discount', 'couponCode', 'isCodEnabled'));
    }
    ...
    public function process(Request $request)
    {
                ...
                if ($existingOrder) {
                    if ($existingOrder->payment_method === 'razorpay') {
                        return response()->json([
                            ...
                            'key' => Setting::where('key', 'razorpay_key_id')->value('value'),
                            'customer' => [
        ...
        try {
            ...
            $razorpayKeyId = Setting::where('key', 'razorpay_key_id')->value('value');
