...
<section class="bg-[#f6cfe0] min-h-screen text-[#1f1f1f] border-t border-[#7f2458]">
  <div class="max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
    ...
    <div class="grid gap-8 lg:gap-10 lg:grid-cols-[520px_minmax(0,1fr)]">
      <div>
        <div class="h-10 bg-[#b9e1de] text-[12px] font-semibold tracking-[0.08em] uppercase text-[#2f3a40] flex items-center justify-center mb-3">
          Buy above ₹2,999 and get 7% off | Use code: AVNEE7
        </div>
      ...
      <div class="pt-1 max-w-[560px]">
        ...
        <div class="mt-5 border border-[#d8b0c5] bg-[#f8dbe8] px-4 py-3 text-center text-[15px] leading-relaxed text-[#5f2d4f]">
          BUY 2 OR MORE KIDS WEAR, GET EXTRA 20% OFF<br /><span class="font-semibold">USE CODE: KIDS20</span>
          <span class="float-right text-[11px] underline">*T&C</span>
        </div>
