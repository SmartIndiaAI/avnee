            ...
            <div class="mb-10">
                ...
                <div class="space-y-4 border {{ $borderColor }} p-4 rounded-sm">
                    <label class="flex items-center gap-3 cursor-pointer group pb-4 border-b {{ $borderColor }}">
                        <input type="radio" name="payment_method" value="razorpay" required checked class="{{ $isDark ? 'text-[#d4af37] bg-[#230030] border-[#4f006a]' : 'text-[#b87333]' }} focus:ring-0 cursor-pointer" />
                        <div class="flex-1">
                    ...
                    <label class="flex items-center gap-3 cursor-pointer group">
                        <input type="radio" name="payment_method" value="cod" required class="{{ $isDark ? 'text-[#d4af37] bg-[#230030] border-[#4f006a]' : 'text-[#b87333]' }} focus:ring-0 cursor-pointer" />
                        <div class="flex-1">
