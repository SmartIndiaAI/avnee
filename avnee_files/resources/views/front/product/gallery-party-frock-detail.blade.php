    ...
    <div class="max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-10 pt-10 pb-24">
        ...
        <div class="flex flex-col lg:flex-row gap-10 lg:gap-14 items-start">
            <div class="w-full lg:w-[46%] space-y-5">
                <div class="max-w-[520px] mx-auto lg:mx-0 border border-[#8cc7c5] bg-[#b8d8d8] text-[#113336] px-5 py-3 text-center">
                    <p class="text-[15px] font-semibold tracking-[0.02em]">Buy above ₹2,999 &amp; get 7% off | Use Code: AVNEE7</p>
                </div>
            ...
            <div class="w-full lg:w-[54%] lg:sticky lg:top-28 {{ $textColor }}">
                ...
                @if($showAgeSizes)
                    <div class="mb-6 border border-[#e4ccd0] bg-[#f2e7e8] text-[#55363a] px-4 py-4 text-center relative">
                        <p class="text-[18px] leading-tight font-medium uppercase">Buy 2 or more kids wear, get extra 20% off</p>
                        <p class="text-[16px] font-semibold mt-1 uppercase">Use Code: KIDS20</p>
                        <span class="absolute right-3 bottom-2 text-[11px] underline font-semibold">*T&amp;C</span>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex flex-wrap gap-2.5 max-w-[520px]" id="gallery-size-options">
                            ...
                            <button type="button" data-size="{{ $sizeOption }}" class="gallery-size-btn h-11 px-4 rounded-full border {{ $borderColor }} text-sm font-semibold {{ $textColor }} hover:bg-black/5 transition-colors {{ $loop->first ? 'bg-black text-white border-black' : '' }}">
                                {{ $sizeOption }}
                            </button>
                            @endforeach
                        </div>
                ...
                <form action="{{ route('cart.add') }}" method="POST" id="gallery-add-to-cart-form" class="space-y-3 mb-8">
                    ...
                    <input type="hidden" name="selected_size" id="gallery-selected-size" value="0-6 Months">
                    ...
                    <div class="mb-2 flex items-center gap-2">
                        ...
                        <button id="gallery-delivery-pincode-check-btn" type="button" class="h-9 px-3 {{ $isDark ? 'bg-[#d4af37] text-[#1a0023]' : 'bg-[#122f2f] text-white' }} text-[11px] font-semibold">Check Service</button>
                    </div>
