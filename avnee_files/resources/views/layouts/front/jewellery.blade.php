...
<head>
  ...
  <!-- Tailwind Config: Atelier Jewellery Theme -->
  <script>
    tailwind.config = {
      darkMode: 'class',
      theme: {
  ...
  <!-- MAIN HEADER                                    -->
  <!-- ═══════════════════════════════════════════════ -->
  <header id="main-header" class="bg-[#4B0082]/95 backdrop-blur-md border-b border-[#A47DAB]/25 transition-all duration-300">
    <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] items-center h-16 sm:h-24 gap-3 sm:gap-4">
        ...
        <div class="flex justify-center">
          <a href="{{ route('front.jewellery') }}" id="logo" class="flex flex-col items-center shrink-0 group">
        ...
        <!-- Right: Action Icons -->
        <div class="flex items-center justify-end gap-2 sm:gap-3 lg:gap-4 font-semibold text-[#fdf2f8] min-w-0">
          ...
          <!-- WhatsApp -->
          <a href="#" id="icon-whatsapp" class="hover:text-[#d4af37] p-1.5 sm:p-2 transition-all" aria-label="WhatsApp" title="WhatsApp">
          ...
          <div class="relative" id="account-menu-root">
            @auth
            <button type="button" id="icon-account" class="hover:text-[#d4af37] p-1.5 sm:p-2 transition-all" aria-label="My Account" title="My Account" aria-expanded="false" aria-controls="account-menu-panel">
            ...
            @else
            <a href="{{ route('login') }}" id="icon-account" class="hover:text-[#d4af37] p-1.5 sm:p-2 transition-all" aria-label="My Account" title="My Account">
              <svg class="w-5 h-5 sm:w-[22px] sm:h-[22px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                  d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
              </svg>
          ...
          <!-- Wishlist -->
          <a href="{{ route('front.wishlist.index') }}" id="icon-wishlist" class="hover:text-[#d4af37] p-1.5 sm:p-2 transition-all" aria-label="Wishlist" title="Wishlist">
            <svg class="w-5 h-5 sm:w-[22px] sm:h-[22px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <!-- Cart with Badge -->
          <a href="{{ route('front.cart.index') }}" id="icon-cart" class="hover:text-[#d4af37] p-1.5 sm:p-2 relative transition-all" aria-label="Cart" title="Shopping Cart">
            <svg class="w-5 h-5 sm:w-[22px] sm:h-[22px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
  ...
  <nav class="lg:hidden bg-[#2B003A] border-y border-[#f8c8dc]/40">
    <div class="px-3">
      <ul class="flex items-center gap-2 py-2 overflow-x-auto whitespace-nowrap hide-scrollbar">
        ...
        <li><a href="{{ route('front.products.index', ['category' => 'accessories']) }}" class="inline-flex px-3 py-1.5 text-[10px] font-extrabold tracking-[0.16em] uppercase text-[#f8c8dc] border border-[#f8c8dc]/40 rounded-sm">Organizers</a></li>
        <li><a href="{{ route('front.products.collection', ['collection' => 'best-sellers']) }}" class="inline-flex px-3 py-1.5 text-[10px] font-extrabold tracking-[0.16em] uppercase text-[#f8c8dc] border border-[#f8c8dc]/40 rounded-sm">Gifting</a></li>
  ...
  <nav id="main-nav" class="bg-[#4B0082] hidden lg:block" style="border-top: 1px solid rgba(164, 125, 171, 0.35); border-bottom: 2px solid #A47DAB;">
    <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 relative">
      <ul class="flex items-center justify-center gap-4 xl:gap-6 h-12">
        ...
        <li><a href="{{ route('front.products.index', ['category' => 'accessories']) }}" class="nav-item-link rounded-sm">ORGANIZERS</a></li>
        <li><a href="{{ route('front.products.collection', ['collection' => 'best-sellers']) }}" class="nav-item-link rounded-sm">GIFTING</a></li>
