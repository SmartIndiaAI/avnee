...
<head>
  ...
  <link
    href="https://fonts.googleapis.com/css2?family=Cinzel:wght@400;500&family=Cormorant+Garamond:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500&family=DM+Sans:wght@300;400;500;600&family=Bodoni+Moda:ital,opsz,wght@0,6..144,400..900;1,6..144,400..900&display=swap"
    rel="stylesheet" />
...
<body class="font-body antialiased bg-[#FCEFF5] text-gray-900">
  ...
  <div class="sm:hidden bg-top-bar border-t border-pastel-pink/20 border-b border-pastel-pink/20">
    <div class="max-w-[1440px] mx-auto px-4 py-2 flex items-center justify-center gap-2">
  ...
  <header id="main-header"
    class="bg-[#770737]/95 backdrop-blur-md border-b border-pastel-pink/20 transition-all duration-300">
    <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between h-16 sm:h-20 gap-4">
        ...
        <div class="flex items-center gap-4 min-w-0">
          ...
          <button id="mobile-menu-btn" class="lg:hidden p-2 -ml-2 text-mulberry hover:text-mulberry/80 transition-colors"
          ...
          <div class="hidden lg:flex w-[360px] xl:w-[460px] max-w-full">
            <div class="relative w-full" id="search-container">
              <input id="search-input" type="text" placeholder="Search for Sarees..."
                class="search-input w-full h-10 pl-4 pr-11 text-sm bg-white/10 border border-pastel-pink/30 placeholder:text-pastel-pink/70 text-pastel-pink transition-all duration-200 focus:ring-1 focus:ring-pastel-pink/50 shadow-inner" autocomplete="off" />
              <button id="search-btn"
                class="absolute right-0 top-0 h-10 w-11 flex items-center justify-center bg-pastel-pink hover:bg-white text-mulberry transition-colors duration-200"
                aria-label="Search">
        ...
        <div class="flex items-center justify-end gap-2 sm:gap-3 lg:gap-4 lg:w-1/3">
          ...
          <button id="mobile-search-btn" class="md:hidden text-pastel-pink hover:text-white p-2 transition-colors"
            aria-label="Search">
          ...
          <!-- WhatsApp -->
          <a href="#" id="icon-whatsapp" class="text-pastel-pink hover:text-white p-1.5 sm:p-2 transition-all"
          ...
          <div class="relative group/account">
            <a href="{{ auth()->check() ? route('dashboard') : route('login') }}" id="icon-account" class="text-pastel-pink hover:text-white p-1.5 sm:p-2 transition-all" aria-label="My Account" title="My Account">
          ...
          <!-- Wishlist -->
          <a href="{{ route('front.wishlist.index') }}" id="icon-wishlist" class="text-pastel-pink hover:text-white p-1.5 sm:p-2 transition-all" aria-label="Wishlist" title="Wishlist">
            <svg class="w-5 h-5 sm:w-[22px] sm:h-[22px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <!-- Cart with Badge -->
          <a href="{{ route('front.cart.index') }}" id="icon-cart" class="text-pastel-pink hover:text-white p-1.5 sm:p-2 transition-all relative" aria-label="Cart" title="Shopping Cart">
            <svg class="w-5 h-5 sm:w-[22px] sm:h-[22px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                d="M15.75 10.5V6a3.75 3.75 0 10-7.5 0v4.5m11.356-1.993l1.263 12c.07.665-.45 1.243-1.119 1.243H4.25a1.125 1.125 0 01-1.12-1.243l1.264-12A1.125 1.125 0 015.513 7.5h12.974c.576 0 1.059.435 1.119 1.007zM8.625 10.5a.375.375 0 11-.75 0 .375.375 0 01.75 0zm7.5 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
            </svg>
            <span
              class="absolute -top-0.5 -right-0.5 sm:top-0 sm:right-0 w-4 h-4 bg-pastel-pink text-mulberry text-[9px] font-bold rounded-full flex items-center justify-center badge-animate">
              {{ $cartCount }}
            </span>
          </a>
      ...
      <div id="mobile-search-bar-container" class="md:hidden pb-4 px-4 overflow-hidden max-h-0 transition-all duration-300 ease-in-out opacity-0">
        <div class="relative w-full">
            <input id="mobile-search-input" type="text" placeholder="Search for Girls Collection, Sarees, Jewelry, Trinkets..."
                class="w-full h-11 pl-4 pr-12 text-sm bg-white/10 border border-pastel-pink/30 placeholder:text-pastel-pink/70 text-pastel-pink focus:outline-none focus:border-pastel-pink" />
            <button class="absolute right-0 top-0 h-11 w-11 flex items-center justify-center bg-pastel-pink text-mulberry"
                aria-label="Search">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="grid grid-cols-[190px_1fr]">
              ...
              <div class="p-3">
                <div class="mega-panel" data-mega-panel="category">
                  <a href="{{ route('front.products.index', ['category' => 'girls-dresses']) }}" class="mega-card"><img src="{{ asset('images/shop-by-style/girls-dresses.png') }}" alt="Kids"><span>Kids</span></a>
                  <a href="{{ route('front.products.index', ['category' => 'sarees']) }}" class="mega-card"><img src="{{ asset('images/party-frocks/Prod2/main.png') }}" alt="Sarees"><span>Sarees</span></a>
                  <a href="{{ route('front.products.index', ['category' => 'jewellery-gallery']) }}" class="mega-card"><img src="{{ asset('images/jewellery/Avnee_s Viraasat Floral Necklace Set/AVN-JW-NEC-RRD-C57/AVN-JW-NEC-RRD-C57-02.png') }}" alt="Jewellery"><span>Jewellery</span></a>
                  <a href="{{ route('front.products.index', ['category' => 'accessories']) }}" class="mega-card"><img src="{{ asset('images/trinkets/WhatsApp Image 2026-04-06 at 3.31.29 AM.jpeg') }}" alt="Accessories"><span>Accessories</span></a>
                  <a href="{{ route('front.products.index', ['category' => 'fun-trinkets']) }}" class="mega-card"><img src="{{ asset('images/trinkets/WhatsApp Image 2026-04-06 at 3.31.28 AM (1).jpeg') }}" alt="Trinkets"><span>Trinkets</span></a>
                </div>
                <div class="mega-panel" data-mega-panel="discount">
                  <a href="{{ route('front.products.collection', ['collection' => 'sale', 'max_price' => 2000]) }}" class="mega-card"><img src="{{ asset('images/shop-by-style/girls-dresses.png') }}" alt="20% and Above"><span>20% And Above</span></a>
                  <a href="{{ route('front.products.collection', ['collection' => 'sale', 'max_price' => 1500]) }}" class="mega-card"><img src="{{ asset('images/party-frocks/Prod6/main.png') }}" alt="30% and Above"><span>30% And Above</span></a>
          ...
          <div class="absolute top-full left-1/2 -translate-x-1/2 mega-menu-panel shadow-2xl hidden group-hover:block z-[120] border border-pastel-pink/40">
            <div class="p-3">
              <div class="mega-panel is-active">
                <a href="{{ route('front.products.index', ['category' => 'girls-dresses']) }}" class="mega-card"><img src="{{ asset('images/shop-by-style/girls-dresses.png') }}" alt="See All Girls"><span>See All Girls</span></a>
                <a href="{{ route('front.products.index', ['category' => 'party-frocks']) }}" class="mega-card"><img src="{{ asset('images/party-frocks/Prod1/main.png') }}" alt="Lehenga"><span>Lehenga</span></a>
                <a href="{{ route('front.products.index', ['category' => 'party-frocks']) }}" class="mega-card"><img src="{{ asset('images/party-frocks/Prod4/main.png') }}" alt="Gown"><span>Gown</span></a>
                <a href="{{ route('front.products.index', ['category' => 'festive-wear']) }}" class="mega-card"><img src="{{ asset('images/shop-by-style/festive-wear.png') }}" alt="Suits"><span>Suits</span></a>
              </div>
            </div>
          </div>
        </li>
            ...
            <div class="grid grid-cols-[190px_1fr]">
              ...
              <div class="p-3">
                <div class="mega-panel" data-mega-panel="collections">
                  <a href="{{ route('front.products.index', ['category' => 'sarees']) }}" class="mega-card"><img src="{{ asset('images/sarees/1.webp') }}" alt="See All Sarees"><span>See All Sarees</span></a>
                  <a href="{{ route('front.products.collection', ['collection' => 'new-arrivals']) }}" class="mega-card"><img src="{{ asset('images/sarees/2.webp') }}" alt="Ready To Ship"><span>Ready To Ship</span></a>
                  <a href="{{ route('front.products.index', ['category' => 'sarees']) }}" class="mega-card"><img src="{{ asset('images/sarees/3.webp') }}" alt="Instant Saree"><span>Instant Saree</span></a>
                  <a href="{{ route('front.products.index', ['category' => 'sarees']) }}" class="mega-card"><img src="{{ asset('images/sarees/4.webp') }}" alt="Printed Saree"><span>Printed Saree</span></a>
                  <a href="{{ route('front.products.index', ['category' => 'sarees']) }}" class="mega-card"><img src="{{ asset('images/sarees/5.webp') }}" alt="Plain Saree"><span>Plain Saree</span></a>
                </div>
                <div class="mega-panel" data-mega-panel="fabric">
                  <a href="{{ route('front.products.index', ['category' => 'sarees']) }}" class="mega-card"><img src="{{ asset('images/sarees/1.webp') }}" alt="Silk"><span>Silk</span></a>
                  <a href="{{ route('front.products.index', ['category' => 'sarees']) }}" class="mega-card"><img src="{{ asset('images/sarees/3.webp') }}" alt="Cotton"><span>Cotton</span></a>
                  <a href="{{ route('front.products.index', ['category' => 'sarees']) }}" class="mega-card"><img src="{{ asset('images/sarees/5.webp') }}" alt="Organza"><span>Organza</span></a>
                </div>
                <div class="mega-panel" data-mega-panel="occasion">
                  <a href="{{ route('front.products.collection', ['collection' => 'best-sellers']) }}" class="mega-card"><img src="{{ asset('images/sarees/2.webp') }}" alt="Wedding"><span>Wedding</span></a>
                  <a href="{{ route('front.products.collection', ['collection' => 'new-arrivals']) }}" class="mega-card"><img src="{{ asset('images/sarees/4.webp') }}" alt="Festive"><span>Festive</span></a>
                  <a href="{{ route('front.products.collection', ['collection' => 'sale']) }}" class="mega-card"><img src="{{ asset('images/sarees/5.webp') }}" alt="Daily"><span>Daily Wear</span></a>
                </div>
                <div class="mega-panel" data-mega-panel="color">
                  <a href="{{ route('front.products.index', ['category' => 'sarees']) }}" class="mega-card"><img src="{{ asset('images/sarees/1.webp') }}" alt="Pastel"><span>Pastel Edit</span></a>
                  <a href="{{ route('front.products.index', ['category' => 'sarees']) }}" class="mega-card"><img src="{{ asset('images/sarees/2.webp') }}" alt="Bold"><span>Bold Tones</span></a>
                  <a href="{{ route('front.products.index', ['category' => 'sarees']) }}" class="mega-card"><img src="{{ asset('images/sarees/3.webp') }}" alt="Neutrals"><span>Neutrals</span></a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="grid grid-cols-[190px_1fr]">
              ...
              <div class="p-3">
                ...
                <div class="mega-panel" data-mega-panel="collection">
                  <a href="{{ route('front.products.index', ['category' => 'jewellery-gallery']) }}" class="mega-card"><img src="{{ asset('images/jewellery/Avnee_s Handmade  Statement Earrings/AVN-JW-HAN-FLA-C45/AVN-JW-HAN-FLA-C45-01.png') }}" alt="Floral"><span>Floral</span></a>
                  <a href="{{ route('front.products.index', ['category' => 'jewellery-gallery']) }}" class="mega-card"><img src="{{ asset('images/jewellery/Avnee_s Handmade  Statement Earrings/AVN-JW-HAN-SHL-C52/AVN-JW-HAN-SHL-C52-01.png') }}" alt="Shell"><span>Shell</span></a>
                  <a href="{{ route('front.products.index', ['category' => 'jewellery-gallery']) }}" class="mega-card"><img src="{{ asset('images/jewellery/Avnee_s Handmade  Statement Earrings/AVN-JW-HAN-BUT-C51/AVN-JW-HAN-BUT-C51-01.png') }}" alt="Butterfly"><span>Butterfly</span></a>
                </div>
              </div>
            </div>
          </div>
  ...
  <!-- FOOTER                                         -->
  <!-- ═══════════════════════════════════════════════ -->
  <footer class="bg-mulberry text-pastel-pink pt-0 pb-6" style="border-top: 3px solid #F8C8DC;">
    ...
    <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-12 pt-16">
        ...
        <div class="pr-0 lg:pr-6">
          <h4 class="footer-heading text-pastel-pink font-semibold tracking-[0.12em] uppercase text-[15px]">About our brand</h4>
          <p class="text-pastel-pink/70 text-[15px] leading-7 mb-4">
          ...
          <p class="text-[#b9ada3] text-[15px] leading-7 mb-6">
  ...
  <script>
    const lookSwiper = new Swiper('.look-swiper', {
      ...
      breakpoints: {
        ...
        1280: { slidesPerView: 5, spaceBetween: -85 },
      },
    });
  </script>
