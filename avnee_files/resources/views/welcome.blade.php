...
@section('content')
  ...
  @php
    $justInLaunchSlides = [
      [
        ...
        'link' => route('front.products.index', ['category' => 'party-frocks']),
        'alt' => 'Just in new launches 1',
      ],
      [
        'image' => asset('images/just-in/Picture2.png'),
        'link' => route('front.products.index', ['category' => 'festive-wear']),
  ...
  <section id="just-in" class="relative w-full px-4 sm:px-6 lg:px-8 py-8 sm:py-10 bg-[#FCEFF5] border-y border-[#d5d5d5]">
    <div class="max-w-[1320px] mx-auto">
      <h2 class="font-heading text-2xl sm:text-4xl text-center text-[#2B003A] font-normal tracking-[0.2em] mb-6 sm:mb-8 uppercase decoration-[#2B003A]/30 underline underline-offset-[12px]">Just in</h2>
  ...
  <section id="best-buy-static" class="py-10 sm:py-14 bg-[#FCEFF5] border-b border-gray-200">
    <div class="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex flex-col items-center justify-center text-center gap-3 mb-6">
        <h2 class="font-heading text-3xl sm:text-4xl text-[#111827]">Best Buy</h2>
      </div>
          ...
          <div class="swiper-wrapper">
            @foreach($bestBuyCards as $card)
              ...
              <div class="swiper-slide p-1 h-auto">
                <article onclick="navigateToBestBuys('{{ $cardSlug }}')" class="bg-white rounded-2xl overflow-hidden border border-gray-200 shadow-sm h-full cursor-pointer transition-transform duration-200 hover:-translate-y-1">
                  ...
                  <div class="p-3 sm:p-4 h-full flex flex-col">
                    <h3 class="text-lg sm:text-xl font-bold text-[#141414] leading-tight min-h-[3.5rem] mb-1">{{ $card['title'] }}</h3>
                    <p class="text-sm sm:text-base text-[#3b3b3b] leading-snug min-h-[3.2rem] mb-2">{{ $card['description'] }}</p>
                    <p class="text-2xl font-black text-[#111827] mt-auto">₹{{ number_format($card['price'], 0) }}</p>
                  </div>
                </article>
              </div>
            @endforeach
  ...
  <section id="home-lookbook" class="py-10 sm:py-14 bg-[#FCEFF5] border-t border-b border-gray-200">
    ...
    <div class="relative max-w-[1060px] mx-auto px-2 sm:px-8" id="lookbook-stage-wrap">
    ...
    <style>
      ...
      @media (max-width: 767px) {
        ...
        .lookbook-stage { grid-template-columns: repeat(3, minmax(0, 1fr)); padding: 8px 4px 14px; gap: 10px; }
        .look-slot-inner {
          min-height: 360px;
        }
  ...
  @php
    $topCollections = [
      ...
      [
        ...
        'button' => 'Explore Now',
        'link' => route('front.products.index', ['collection' => 'new-arrivals']),
      ...
      [
        'title' => 'Daily Wear',
        'button' => 'Explore Now',
        'link' => route('front.products.index', ['category' => 'girls-dresses']),
  ...
  <section id="home-top-collections" class="py-10 sm:py-12 bg-[#FCEFF5] border-y border-[#f0dce2]">
    <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
      <h2 class="font-heading text-2xl sm:text-4xl text-center text-mulberry font-normal tracking-[0.2em] mb-8 sm:mb-12 uppercase decoration-mulberry/30 underline underline-offset-[12px]">
        Top Collection
      </h2>
  ...
  <section id="shop-by-price-static" class="py-12 sm:py-16 bg-[#FCEFF5]">
    <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
      <h2 class="font-heading text-2xl sm:text-4xl text-center text-mulberry font-normal tracking-[0.2em] mb-10 sm:mb-14 uppercase decoration-mulberry/30 underline underline-offset-[12px]">Shop by Price</h2>
      <div class="flex flex-wrap justify-center gap-6 sm:gap-10 lg:gap-16">
        ...
        <a href="{{ $band['url'] }}" class="price-badge-wrap group relative flex items-center justify-center w-32 h-32 sm:w-40 sm:h-40 lg:w-48 lg:h-48">
          <svg class="absolute inset-0 w-full h-full drop-shadow-xl badge-svg transition-transform duration-500 group-hover:scale-110" viewBox="0 0 200 200">
          ...
          <div class="relative z-10 flex flex-col items-center justify-center text-center">
            ...
            <span class="font-heading text-2xl sm:text-3xl lg:text-4xl font-bold text-pastel-pink tracking-wider">₹{{ $band['price'] }}</span>
          </div>
        </a>
        @endforeach
      </div>
    ...
    <div class="w-full px-3 sm:px-4 lg:px-8 xl:px-10">
      ...
      @php
        $styleCards = [
          ...
          ['label' => '2-4 Years', 'slug' => '2-4-years', 'image' => 'images/shop-by-style/2-4-years.png'],
          ['label' => '4-6 Years', 'slug' => '4-6-years', 'image' => 'images/shop-by-style/4-6-years.png'],
          ['label' => '6-14 Years', 'slug' => '6-14-years', 'image' => 'images/shop-by-style/6-14-years.png'],
          ['label' => 'Festive Wear', 'slug' => 'festive-wear', 'image' => 'images/shop-by-style/festive-wear.png'],
          ['label' => 'Girls Dresses', 'slug' => 'girls-dresses', 'image' => 'images/shop-by-style/girls-dresses.png'],
      ...
      <div class="grid w-full grid-cols-2 sm:grid-cols-3 lg:grid-cols-7 gap-x-5 sm:gap-x-7 lg:gap-x-10 xl:gap-x-12 gap-y-5 sm:gap-y-6">
        @foreach($styleCards as $styleCard)
          ...
          <a href="{{ route('front.products.index', ['category' => $styleCard['slug']]) }}" class="group block text-center">
            ...
            <p class="mt-3 text-sm sm:text-base text-[#2B003A] font-medium tracking-wide">{{ $styleCard['label'] }}</p>
          </a>
        @endforeach
      </div>
    </div>
    ...
    <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex flex-col md:flex-row items-center justify-between mb-10 gap-6">
        <div class="flex items-center gap-4">
          ...
          <div>
            <h2 class="font-heading text-2xl sm:text-3xl font-normal tracking-[0.1em] text-mulberry uppercase decoration-mulberry/30 underline underline-offset-[8px]">{{ $activeFlashSale->title }}</h2>
    ...
    <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex flex-col md:flex-row justify-between items-center mb-12 gap-6 text-center md:text-left">
        <div>
          ...
          <h2 class="font-heading text-2xl sm:text-4xl text-center md:text-left text-mulberry font-normal tracking-[0.2em] mb-8 uppercase decoration-mulberry/30 underline underline-offset-[12px]">Combo Deals</h2>
  ...
  <section id="popular-pieces" class="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 max-w-[1440px] mx-auto overflow-hidden">
    <h2 class="font-heading text-2xl sm:text-4xl text-center text-mulberry font-normal tracking-[0.2em] mb-8 sm:mb-10 uppercase decoration-mulberry/30 underline underline-offset-[12px]">
      New In Jewellery
    </h2>
    <div class="relative group">
    ...
    <div class="max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="relative group">
        ...
        <div class="swiper studio-edits-swiper overflow-hidden">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <h2 class="font-heading text-3xl sm:text-4xl text-center text-[#111827] font-normal tracking-tight mb-9 sm:mb-12">The Saree Edit</h2>
              <div class="bg-[#efe8e8] p-4 sm:p-6 lg:p-7 grid grid-cols-1 lg:grid-cols-[1.22fr_0.98fr] gap-3 sm:gap-4 lg:gap-6">
                ...
                <div class="flex items-center justify-center text-center px-2 sm:px-6 lg:px-10 py-6 sm:py-10">
                  <div class="max-w-[420px]">
                    ...
                    <a href="{{ route('front.products.index', ['category' => 'sarees']) }}" class="inline-block bg-black text-white text-sm sm:text-base font-bold tracking-[0.04em] px-7 py-3.5 hover:bg-[#1f1f1f] transition-colors mb-8">PRE-DRAPE NOW</a>
            ...
            <div class="swiper-slide">
              <h2 class="font-heading text-3xl sm:text-4xl text-center text-[#111827] font-normal tracking-tight mb-9 sm:mb-12">{{ $funTrinketsExp->title ?? 'The Fun Trinkets Edit' }}</h2>
              <div class="bg-[#efe8e8] p-4 sm:p-6 lg:p-7 grid grid-cols-1 lg:grid-cols-[1.22fr_0.98fr] gap-3 sm:gap-4 lg:gap-6">
                <div class="grid grid-cols-[1.05fr_0.95fr] gap-3 sm:gap-4">
                  <div class="row-span-2">
                ...
                <div class="flex items-center justify-center text-left px-2 sm:px-6 lg:px-10 py-6 sm:py-10">
                  <div class="max-w-[420px]">
                    ...
                    <a href="{{ $funTrinketsExp->button_link ?? route('front.products.index', ['category' => 'fun-trinkets']) }}" class="inline-block bg-black text-white text-sm sm:text-base font-bold tracking-[0.04em] px-7 py-3.5 hover:bg-[#1f1f1f] transition-colors">{{ $funTrinketsExp->button_text ?? 'SHOP NOW' }}</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="swiper-slide">
              <h2 class="font-heading text-3xl sm:text-4xl text-center text-[#111827] font-normal tracking-tight mb-9 sm:mb-12">{{ $hairAccessoriesExp->title ?? 'The Hair Accessories Edit' }}</h2>
              <div class="bg-[#efe8e8] p-4 sm:p-6 lg:p-7 grid grid-cols-1 lg:grid-cols-[0.95fr_1.05fr] gap-3 sm:gap-4 lg:gap-6">
                <div class="flex items-center justify-center text-left px-2 sm:px-6 lg:px-10 py-6 sm:py-10">
                  <div class="max-w-[420px]">
                    ...
                    <a href="{{ $hairAccessoriesExp->button_link ?? route('front.products.index', ['category' => 'accessories']) }}" class="inline-block bg-black text-white text-sm sm:text-base font-bold tracking-[0.04em] px-7 py-3.5 hover:bg-[#1f1f1f] transition-colors">{{ $hairAccessoriesExp->button_text ?? 'SHOP NOW' }}</a>
                  </div>
                </div>
