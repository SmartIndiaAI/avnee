...
Route::get('/collections/{collection}', [ProductController::class, 'collection'])
    ->whereIn('collection', ['sale', 'new-arrivals', 'best-sellers', 'bogo'])
...
Route::post('/cart/add', [CartController::class, 'add'])->middleware(['auth', 'active.customer'])->name('cart.add');
Route::post('/cart/combo/{id}', [CartController::class, 'addCombo'])->middleware(['auth', 'active.customer'])->name('cart.add.combo');
Route::get('/cart/combo/{id}/details', [CartController::class, 'getComboDetails'])->name('front.cart.combo.details');
Route::patch('/cart/update/{id}', [CartController::class, 'update'])->middleware(['auth', 'active.customer'])->name('front.cart.update');
Route::delete('/cart/remove/{id}', [CartController::class, 'remove'])->middleware(['auth', 'active.customer'])->name('front.cart.remove');
